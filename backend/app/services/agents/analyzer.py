...
class AnalyzerAgent:
    ...
    async def retrieve_knowledge(self, query: str, collection: str = "nutrisync") -> List[Dict[str, Any]]:
        ...
        try:
            ...
            chunks = await asyncio.to_thread(self.rag_service.retrieve, query, collection_name=collection, top_k=5)
            return chunks
    ...
    async def analyze_query(
        self, query: str, meals: Optional[List[Dict]] = None, collection: str = "nutrisync"
    ) -> Dict[str, Any]:
