...
MEDICAL_ANCHORS = {
    ...
    "pcos", "polycystic", "anaemia", "anemia", "iron", "ferritin",
    "haemoglobin", "b12", "cobalamin", "folate", "folic acid",
    "vitamin d", "calcium", "protein", "calorie", "calories", "bmi", "bmr",
    "tdee", "rda", "glp-1", "semaglutide", "liraglutide", "obesity",
    "cholesterol", "triglyceride", "hdl", "ldl", "hypertension",
    "pregnancy", "pregnant", "lactation", "trimester",
    "ifct", "icmr", "nin", "millet", "ragi", "jowar", "bajra", "quinoa",
    "dal", "lentil", "chickpea", "paneer", "ghee", "katori", "roti",
    "chapati", "idli", "dosa",
}
